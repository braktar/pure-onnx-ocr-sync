...
| `[ ]`  | `task-fix-002`        | Replace provisional recognition confidence metric with softmax-based scoring | Depends on task-fix-001; update docs once stable confidences observed |
